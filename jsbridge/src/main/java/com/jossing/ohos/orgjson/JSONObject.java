...
package com.jossing.ohos.orgjson;
...
public class JSONObject {
     ...
     * be skipped.
     */
    public JSONObject(@NotNull JSONObject copyFrom, @NotNull String /*@NotNull*/[] names) throws JSONException {
        this();
     ...
     */
    @Nullable
    public String optString(@Nullable String name, @Nullable String fallback) {
        Object object = opt(name);
        String result = JSON.toString(object);
        return result != null ? result : fallback;
    }
     ...
     */
    @NotNull
    public Iterator</*@NotNull*/ String> keys() {
